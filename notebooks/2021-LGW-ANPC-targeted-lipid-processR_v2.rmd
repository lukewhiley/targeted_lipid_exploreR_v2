...
write_csv(final_corrected_data, 
          paste0(Sys.Date(), project_dir, "/", project_name, "_", user_name, "_lipidexploreRv2_individual_lipid_data.csv")
          )

write_csv(final_corrected_class_lipid_data, 
          paste0(Sys.Date(), project_dir, "/", project_name, "_", user_name, "_lipidexploreRv2_summed_lipid_class_data.csv")
          )
